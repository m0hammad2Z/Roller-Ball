    ...
    public struct GameMapActions
    {
        ...
        public void SetCallbacks(IGameMapActions instance)
        {
            if (m_Wrapper.m_GameMapActionsCallbackInterface != null)
            {
                ...
                @RightArrow.started -= m_Wrapper.m_GameMapActionsCallbackInterface.OnRightArrow;
                @RightArrow.performed -= m_Wrapper.m_GameMapActionsCallbackInterface.OnRightArrow;
                @RightArrow.canceled -= m_Wrapper.m_GameMapActionsCallbackInterface.OnRightArrow;
                @LeftArrow.started -= m_Wrapper.m_GameMapActionsCallbackInterface.OnLeftArrow;
                @LeftArrow.performed -= m_Wrapper.m_GameMapActionsCallbackInterface.OnLeftArrow;
                @LeftArrow.canceled -= m_Wrapper.m_GameMapActionsCallbackInterface.OnLeftArrow;
            }
